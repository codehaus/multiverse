...
public class ImprovedUncontendedLeanReadBenchmark implements BetaStmConstants {

    private BetaStm stm;

    public static void main(String[] args) {
        ImprovedUncontendedLeanReadBenchmark test = new ImprovedUncontendedLeanReadBenchmark();
