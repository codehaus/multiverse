 ...
 */
public class UncontendedAtomicGetBenchmark {

    private BetaStm stm;

    public static void main(String[] args) {
        UncontendedAtomicGetBenchmark test = new UncontendedAtomicGetBenchmark();
    ...
    private double test(int threadCount, long transactionsPerThread) {
        ...
        System.out.printf("Multiverse> Performance %s reads/second\n",
