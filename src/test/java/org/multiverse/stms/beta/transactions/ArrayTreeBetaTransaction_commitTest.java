 ...
 */
public class ArrayTreeBetaTransaction_commitTest {
    private BetaStm stm;
    ...
    public void whenListenerAvailableForUpdate_thenListenerNotified() {
        ...
        ArrayTreeBetaTransaction listeningTx = new ArrayTreeBetaTransaction(stm);
        LongRefTranlocal read = listeningTx.openForRead(ref, false, pool);
        Latch latch = new CheapLatch();
        listeningTx.registerChangeListenerAndAbort(latch, pool);

        ArrayTreeBetaTransaction updatingTx = new ArrayTreeBetaTransaction(stm);
    ...
    public void whenNormalUpdateButNotChange() {
        ...
        ArrayTreeBetaTransaction tx = new ArrayTreeBetaTransaction(new BetaTransactionConfig(stm));
    ...
    public void writeSkewStillPossible() {
        ...
        BetaTransaction tx2 = new ArrayTreeBetaTransaction(stm);
    ...
    public void whenWriteConflict() {
        ...
        BetaTransaction tx = new ArrayTreeBetaTransaction(stm);
        LongRefTranlocal write = tx.openForWrite(ref, false, pool);
        write.value++;
