 ...
 */
public final class IntRef extends FastOrec implements BetaTransactionalObject {
    ...
    static {
        try {
            listenersOffset = unsafe.objectFieldOffset(IntRef.class.getDeclaredField("listeners"));
        } catch (Exception ex) {
            throw new Error(ex);
        }
    }
    ...
    public volatile IntRefTranlocal active;
    ...
    public IntRef(int value){
        active = new IntRefTranlocal(this);
        active.value = value;
    ...
    @Override
    public final IntRefTranlocal load(final int spinCount) {
        while (true) {
            IntRefTranlocal loaded = active;
    ...
    @Override
    public final IntRefTranlocal lockAndLoad(final int spinCount, final BetaTransaction newLockOwner) {
    ...
    @Override
    public final IntRefTranlocal unsafeLoad() {
        return active;
    }

    @Override
    public final IntRefTranlocal openForConstruction(final ObjectPool pool) {
    ...
    public final Listeners commitDirty(
        ...
        final IntRefTranlocal newActive = (IntRefTranlocal)tranlocal;
        newActive.prepareForCommit();
        final IntRefTranlocal oldActive = active;
        active = newActive;
    ...
    public final void abort(final BetaTransaction transaction, final Tranlocal tranlocal, final ObjectPool pool) {
        ...
        IntRefTranlocal update;
        IntRefTranlocal read;
        if (tranlocal.isCommitted) {
            update = null;
            read = (IntRefTranlocal)tranlocal;
        } else {
            update = (IntRefTranlocal)tranlocal;
    ...
    public final int atomicSet(
        final int newValue, final ObjectPool pool, final int spinCount,
        final GlobalConflictCounter globalConflictCounter){
