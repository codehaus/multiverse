 ...
 */
public final class DoubleRef extends FastOrec implements BetaTransactionalObject {
    ...
    static {
        try {
            listenersOffset = unsafe.objectFieldOffset(DoubleRef.class.getDeclaredField("listeners"));
        } catch (Exception ex) {
            throw new Error(ex);
        }
    }
    ...
    public volatile DoubleRefTranlocal active;
    ...
    public DoubleRef(BetaTransaction tx){
    ...
    public DoubleRef(double value){
        active = new DoubleRefTranlocal(this);
        active.value = value;
    ...
    @Override
    public final DoubleRefTranlocal load(final int spinCount) {
        while (true) {
            DoubleRefTranlocal loaded = active;
    ...
    @Override
    public final DoubleRefTranlocal lockAndLoad(final int spinCount, final BetaTransaction newLockOwner) {
    ...
    @Override
    public final DoubleRefTranlocal unsafeLoad() {
        return active;
    }

    @Override
    public final DoubleRefTranlocal openForConstruction(final ObjectPool pool) {
    ...
    public final Listeners commitDirty(
        ...
        if(expectedLockOwner != lockOwner){
            ...
            if(!read.isPermanent && departAfterReading()){
                ...
                ((DoubleRefTranlocal)read).markAsPermanent();
        ...
        final DoubleRefTranlocal newActive = (DoubleRefTranlocal)tranlocal;
        newActive.prepareForCommit();
        final DoubleRefTranlocal oldActive = active;
        active = newActive;
    ...
    public final Listeners commitAll(
        ...
        if(expectedLockOwner != lockOwner){
            ...
            if(!tranlocal.isPermanent && departAfterReading()){
                ...
                ((DoubleRefTranlocal)tranlocal).markAsPermanent();
                unlockAfterBecomingReadBiased();
            }
            return null;
        }
    ...
    public final void abort(final BetaTransaction transaction, final Tranlocal tranlocal, final ObjectPool pool) {
        ...
        DoubleRefTranlocal update;
        DoubleRefTranlocal read;
        if (tranlocal.isCommitted) {
            update = null;
            read = (DoubleRefTranlocal)tranlocal;
        } else {
            update = (DoubleRefTranlocal)tranlocal;
    ...
    public final double atomicGet(){
        DoubleRefTranlocal read = active;
        if(read.isPermanent){
            return read.value;
        }
    ...
    public final double atomicSet(
        final double newValue, final ObjectPool pool, final int spinCount,
        final GlobalConflictCounter globalConflictCounter){
