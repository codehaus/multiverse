 ...
 */
public final class Ref<E> extends FastOrec implements BetaTransactionalObject {
    ...
    @Override
    public final RefTranlocal<E> openForConstruction(final ObjectPool pool) {
    ...
    public void commitConstructed(final Tranlocal tranlocal){
        final RefTranlocal<E> newActive = (RefTranlocal<E>)tranlocal;
    ...
    public final E atomicSet(
        final E newValue, final ObjectPool pool, final int spinCount,
        final GlobalConflictCounter globalConflictCounter){
