...
public final class BetaLongRef
    ...
    public final void increment() {
        commute(Functions.newIncLongFunction());
    }
    ...
    public final void increment(long amount) {
        commute(Functions.newIncLongFunction(amount));
    }

    public final void increment(Transaction tx, long amount) {
        commute(tx, Functions.newIncLongFunction(amount));
    }

    public final void decrement() {
        commute(Functions.newIncLongFunction(-1));
    }

    public final void decrement(Transaction tx) {
        commute(tx, Functions.newIncLongFunction(-1));
    }
    ...
    public final void decrement(Transaction tx, long amount) {
        commute(tx, Functions.newIncLongFunction(-amount));
    }
