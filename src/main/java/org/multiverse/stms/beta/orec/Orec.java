...
public interface Orec {
     ...
     * @throws IllegalStateException if read biased.
     */
     ...
     * @throws IllegalStateException if surplus is 0, or readbiased, or not locked.
     */
     ...
     * @throws IllegalStateException if the surplus is 0 (a tryUpdateLock only can be done if the current
   ...
   /**
     ...
     *
     * @throws IllegalStateException if the lock is not acquired.
     */
