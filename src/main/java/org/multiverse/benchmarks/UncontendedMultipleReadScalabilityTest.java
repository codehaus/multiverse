...
public class UncontendedMultipleReadScalabilityTest {
    ...
    class ReadThread extends Thread {
        ...
        public void run2() {
            ...
            BetaTransactionConfig config = new BetaTransactionConfig(stm).setReadonly(true);
            ArrayBetaTransaction tx = new ArrayBetaTransaction(config, 2);
        ...
        public void run4() {
            ...
            BetaTransactionConfig config = new BetaTransactionConfig(stm).setReadonly(true);
            ArrayBetaTransaction tx = new ArrayBetaTransaction(config, 4);
        ...
        public void run8() {
            ...
            BetaTransactionConfig config = new BetaTransactionConfig(stm).setReadonly(true);
            ArrayBetaTransaction tx = new ArrayBetaTransaction(config, 8);
        ...
        public void run16() {
            ...
            BetaTransactionConfig config = new BetaTransactionConfig(stm).setReadonly(true);
            ArrayBetaTransaction tx = new ArrayBetaTransaction(config, 16);
