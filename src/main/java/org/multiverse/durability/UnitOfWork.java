 ...
 * <p/>
 * A UnitOfWork essentially is the same as a transaction where all change committed are atomic, isolated, consistent
 * etc. But a different name is chosen to prevent confusion.
 * <p/>
 * UnitOfWork is not threadsafe.
 *
...
public interface UnitOfWork {
    ...
    /**
     * Adds a new root to this UnitOfWork.
     *
     * @param root the root to add.
     * @throws NullPointerException  if root is null.
     * @throws IllegalStateException if the UnitOfWork is not in the active state.
     */
    void addRoot(DurableObject root);

    /**
     * Adds a change to this UnitOfWork.
     * <p/>
     ...
     * responsibility of this UnitOfWork but of the Transaction that uses it.
     *
     * @throws IllegalStateException if the UnitOfWork is not in the active state.
     */
    void commit();
