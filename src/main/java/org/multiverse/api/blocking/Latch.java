...
/**
 * A blocking structure that can be used to create blocking transactions. When a transaction blocks, a 'listener' is
...
public interface Latch {
    ...
    /**
     * Resets this latch for usage and returns the listenerEra. The listenerEra can be used to
     *
     * @return
     */
    long reset();
