 ...
 */
public class AlphaProgrammaticLong_constructionTest {
    ...
    public void whenAborted_thenDeadTransactionException() {
        ...
        long version = stm.getVersion();
        try {
            new AlphaProgrammaticLong(tx, 10);
            fail();
    ...
    public void whenNullTransaction_thenNullPointerException() {
        ...
        try {
            new AlphaProgrammaticLong((AlphaTransaction) null, 10);
            fail();
    ...
    public void whenTransactionUsed() {
        ...
        String value = "foo";
        AlphaProgrammaticReference ref = new AlphaProgrammaticReference(tx, value);
