 ...
 * reference api. It uses an AlphaProgrammaticLong and AlphaProgrammaticRef.
 *
...
public class AlphaProgrammaticLongAndReference_integrationStressTest {
    ...
    private final static ProgrammaticReferenceFactory refFactory = getGlobalStmInstance()
    ...
    public class Queue<E> {
        ...
        private final ProgrammaticLong size = refFactory.atomicCreateLong(0);
    ...
    public class Stack<E> {
        ...
        final ProgrammaticReference<Node<E>> head = refFactory.atomicCreateReference(null);
