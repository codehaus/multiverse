...
/**
 * BasicRef that fixes the Aba problem.
 * <p/>
 * See the BasicRef for more documentation about the Aba problem.
 *
 * @author Peter Veentjer
 */
public class AbaRef<E> extends BasicTransactionalObjectMixin {
