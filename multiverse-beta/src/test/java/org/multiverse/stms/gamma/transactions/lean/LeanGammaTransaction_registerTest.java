...
public abstract class LeanGammaTransaction_registerTest<T extends GammaTransaction> {
    ...
    public void whenNullListener_thenNullPointerException() {
        ...
        assertIsAborted(tx);
        assertFalse(tx.getConfiguration().getSpeculativeConfiguration().areListenersDetected);
    }
    ...
    public void whenSuccess() {
        ...
        assertIsAborted(tx);
        assertTrue(tx.getConfiguration().getSpeculativeConfiguration().areListenersDetected);
