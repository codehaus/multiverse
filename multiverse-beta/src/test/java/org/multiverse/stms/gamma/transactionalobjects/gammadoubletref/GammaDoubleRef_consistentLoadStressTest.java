...
public class GammaDoubleRef_consistentLoadStressTest implements GammaConstants {

    private GammaStm stm;
    private volatile boolean stop;
    private GammaDoubleRef ref;
    ...
    public void setUp() {
        stm = new GammaStm();
        stop = false;
        ref = new GammaDoubleRef(stm, VERSION_UNCOMMITTED + 1);
    }
    ...
    class UpdateThread extends TestThread {
        ...
        public void doRun() throws Exception {
            ...
            while (!stop) {
                ...
                ref.long_value = doubleAsLong(ref.version + 1);
