...
public class GammaBooleanRef_constructionTest {
    ...
    public void whenInitialValueUsed() {
        ...
        GammaTestUtils.assertVersionAndValue(ref, GammaConstants.VERSION_UNCOMMITTED + 1, true);
    ...
    public void whenDefaultValueUsed() {
        ...
        assertVersionAndValue(ref, GammaConstants.VERSION_UNCOMMITTED + 1, false);
        assertRefHasNoLocks(ref);
        assertReadonlyCount(ref, 0);
        assertSurplus(ref, 0);
    }
