...
public class ImprovedUncontendedLeanUpdateBenchmark implements BetaStmConstants {

    private BetaStm stm;

    public static void main(String[] args) {
        ImprovedUncontendedLeanUpdateBenchmark test = new ImprovedUncontendedLeanUpdateBenchmark();
    ...
    public void start(long transactionCount) {
        ...
        System.out.println("Multiverse> Uncontended update lean-transaction benchmark");
