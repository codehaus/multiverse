...
public class CliffCounter {
    ...
    private static final AtomicReferenceFieldUpdater<CliffCounter, CAT> _catUpdater =
    ...
    private static class CAT implements Serializable {
        ...
        public long add_if_mask(long x, long mask, int hash, CliffCounter master) {
            long[] t = _t;
