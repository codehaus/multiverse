 ...
 */
public class TransactionalLinkedList_TakeLastPutFirstLongTest {
    ...
    public void setUp() {
        ...
        deque = new TransactionalLinkedList<Long>(dequeCapacity);
    ...
    public class PutFirstThread extends TestThread {
        ...
        public void doRun() throws Exception {
            for (int k = 0; k < produceCount; k++) {
                deque.putFirst(itemGenerator.incrementAndGet());
