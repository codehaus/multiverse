...
public class CycleHandlingTest {
    ...
    static class ComplexNode {
        ...
        final Ref<ComplexNode> edge1Ref = new Ref<ComplexNode>();
        final Ref<ComplexNode> edge2Ref = new Ref<ComplexNode>();
        final Ref<ComplexNode> edge3Ref = new Ref<ComplexNode>();
